...
{
    public partial class Danh_Sach_Benh_Vien : DevExpress.XtraEditors.XtraForm
    {
        private Loadding loadingControl;
        private readonly HttpClient _httpClient = new HttpClient();
        public Danh_Sach_Benh_Vien()
        {
            InitializeComponent();
        ...
        private async void Danh_Sach_Benh_Vien_Load(object sender, EventArgs e)
        {
